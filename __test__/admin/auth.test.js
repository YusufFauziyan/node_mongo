...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Nola92',
      password: 'mNMnit2ryvcR5PQ',
      email: 'Jordi_Halvorson53@hotmail.com',
      name: 'Lorenzo Quitzon',
      userType: 619,
      mobileNo: '(666) 183-0694',
      resetPasswordLink: {},
      loginRetryLimit: 529,
      loginReactiveTime: '2024-04-19T07:01:42.536Z',
      id: '64f1ea272f3ee4b148e15732'
    });
  }
  catch (error) {
  ...
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        ...
        'password':'YzCDrOEwGE0Akup',
        'email':'Emilie10@yahoo.com',
        'name':'Gertrude Zulauf',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(918) 010-7294',
