...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'LxTI0wrihjfkAQW',
      'isDeleted':false,
      'username':'Keenan_Wolf41',
      'email':'Torey58@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Keenan_Wolf41' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'HzHHFS3ROsfUPZ2',
      'isDeleted':false,
      'username':'Hardy.Batz12',
      'email':'Dixie.Hoeger@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Hardy.Batz12' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
