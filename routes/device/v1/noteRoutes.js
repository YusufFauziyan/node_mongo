...
const noteController = require('../../../controller/device/v1/note');
const {
...
router.route('/device/api/v1/note/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,noteController.getNoteById);
