...
const CommentController = require('../../../controller/device/v1/Comment');
const {
...
router.route('/device/api/v1/comment/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,CommentController.getCommentById);
