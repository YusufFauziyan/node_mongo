...
const Chat_groupController = require('../../controller/admin/Chat_group');
const {
...
router.route('/admin/chat_group/:id').get(auth(PLATFORM.ADMIN),checkRolePermission,Chat_groupController.getChat_groupById);
