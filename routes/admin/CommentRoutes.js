...
const CommentController = require('../../controller/admin/Comment');
const {
...
router.route('/admin/comment/:id').get(auth(PLATFORM.ADMIN),checkRolePermission,CommentController.getCommentById);
