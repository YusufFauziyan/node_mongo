...
const medicationController = require('../../controller/admin/medication');
const {
...
router.route('/admin/medication/:id').get(auth(PLATFORM.ADMIN),checkRolePermission,medicationController.getMedicationById);
